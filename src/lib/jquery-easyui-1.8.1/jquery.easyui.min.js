...
(function($) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _a71,
        rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _9e6(true), mouseout: _9e6(false), click: _9e8 }),
        ...
        $(_abe).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [
                [{
                    ...
                    width: "100%",
                    formatter: function(_abf, row, _ac0) {
